...
public class Application {
    ...
    public static boolean init(String initInfo) {
        ...
        for (String s : parkingList) {
            ...
            JDBC.initParkingLots(parkingInfo[0], Integer.parseInt(parkingInfo[1]));
            JDBC.createParking(parkingInfo[0]);
        }
        return true;
    }
    ...
    public static String park(String carNumber) {
        ...
        int parkingSpaceId = firstEmptyParking.getSpace() - firstEmptyParking.getRestSpace() + 1;
        JDBC.countParkingSpace(parkingId);
    ...
    public static String fetch(String ticket) {
        ...
        if (JDBC.findCar(ticketParkingId, ticketSpaceId, carNumber)) {
